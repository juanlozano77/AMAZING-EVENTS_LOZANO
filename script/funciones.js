...
const resaltarTexto=(clases,arrayTexto)=>{ 
  

  const tarjetasTexto = Array.from(document.querySelectorAll(clases));
...
const filtrarEventos=(eventos,textoABuscar)=> {
  ...
  if (tarjetasFiltradas){
    ...
    resaltarTexto("p.card-text",arrayTexto)
  resaltarTexto("h5.card-title",arrayTexto)
  }
}
